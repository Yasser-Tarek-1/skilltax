const ContactUs = () => {
  return (
    <section id="contactUs" className="pt-28 md:pt-52">
      <div className="w-full flex items-center lg:gap-8 flex-col-reverse lg:flex-row">
        ...
        <div className="w-full h-[830px] bg-[#F8F8F8] p-6 lg:p-10 border-[3px] border-[#EEEEEEEE] rounded-[40px]">
          <h3 className="text-[20px] lg:text-[35px] font-[dinFontBold]">
            تواصل معنا
          </h3>
          {/* Contact Us Form */}
          <form className="mt-10 flex flex-col gap-9">
            <div className="flex items-center gap-8 w-full flex-col lg:flex-row">
              <div className="flex items-start flex-col gap-3 w-full">
                <label className="text-base lg:text-lg" htmlFor="name">
                  الاسم
                </label>
                <input
                  id="name"
              ...
              <div className="flex items-start flex-col gap-3 w-full">
                <label className="text-base lg:text-lg" htmlFor="surName">
                  الاسم
                </label>
                <input
                  id="surName"
                  type="text"
                  className="w-full outline-none border-[1.5] border-[#ECECEC] rounded-[100px] h-14 lg:h-16 px-7 lg:px-8"
                  placeholder="اكتب لقبك هنا"
                />
              </div>
            </div>
            <div className="flex items-start flex-col gap-3 w-full">
              <label className="text-base lg:text-lg" htmlFor="phone">
                رقم الهاتف
              </label>
              <input
                id="phone"
            ...
            <div className="flex items-start flex-col gap-3 w-full">
              <label className="text-base lg:text-lg" htmlFor="email">
                البريد الالكتروني
              </label>
              <input
                id="email"
            ...
            <div className="flex items-start flex-col gap-3 w-full">
              <label className="text-base lg:text-lg" htmlFor="company">
                اسم الشركة
              </label>
              <input
                id="company"
        ...
        >
          ...
          <div className="relative z-10 p-9 lg:p-12 text-white">
            <h4 className="text-[20px] lg:text-[30px]">
